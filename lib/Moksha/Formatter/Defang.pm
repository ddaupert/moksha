package Moksha::Formatter::Defang;
use strict;
use warnings;
use parent qw/Moksha::Formatter/;
use Moksha::Declaw;
use URI;

=head1 NAME

Moksha::Formatter::Defang - Scrub user HTML and XSS

=head1 DESCRIPTION

This formatter makes sure only a safe range of tags are
allowed, using L<Moksha::Defang>; It also tries to remove XSS attempts.
...
L<Moksha>, L<Module::Pluggable::Ordered>, L<Moksha::Defang>
