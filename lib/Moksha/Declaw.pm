package Moksha::Declaw;

=head1 NAME

Moksha::Declaw - Cleans HTML as well as CSS of scripting and other executable contents, and neutralises XSS attacks.
...
=item I<Moksha::Declaw-E<gt>new(%Options)>
